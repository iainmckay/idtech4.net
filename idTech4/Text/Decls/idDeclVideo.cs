...
namespace idTech4.Text.Decls
{
	public class idDeclVideo : idDecl
	{
		...
		public override int MemoryUsage
		{
			get
			{
				idLog.Warning("TODO: idDeclVideo.MemoryUsage");
		...
		public override bool Parse(string text)
		{
			...
			string baseStrID = string.Format("#str_{0}_video_", this.Name);
			...
			while(true)
			{
				...
				{
					_video = declManager.FindMaterial(lexer.ReadToken().ToString());
				}
			}
