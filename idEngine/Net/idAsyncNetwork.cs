...
namespace idTech4.Net
{
	internal class idAsyncNetwork
	{
		...
		{
			new idCvar("net_verbose", "0", "1 = verbose output, 2 = even more verbose output", 0, 2, CvarFlags.System | CvarFlags.Integer | CvarFlags.NoCheat /* TODO: , idCmdSystem::ArgCompletion_Integer<0,2> */);
...
#else
			new idCvar("net_serverDedicated", "0", "1 = text console dedicated server, 2 = graphical dedicated server", 0, 2, CvarFlags.ServerInfo | CvarFlags.System | CvarFlags.Integer | CvarFlags.NoCheat /* TODO: , idCmdSystem::ArgCompletion_Integer<0,2>*/);
#endif
			...
			new idCvar("net_serverMaxUsercmdRelay", "5", "maximum number of usercmds from other clients the server relays to a client", 1, idE.MaxUserCommandRelay, CvarFlags.System | CvarFlags.Integer | CvarFlags.NoCheat /* TODO: , idCmdSystem::ArgCompletion_Integer<1,MAX_USERCMD_RELAY>*/);
