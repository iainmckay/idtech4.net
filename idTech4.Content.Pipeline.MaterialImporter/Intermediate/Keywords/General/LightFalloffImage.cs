...
{
	[LexerKeyword("lightFalloffImage")]
	public class LightFalloffImage : LexerKeyword<MaterialContent>
	{
		public override bool Parse(idLexer lexer, ContentImporterContext context, MaterialContent content)
		{
			...
			// light volumes
			content.LightFalloffImage = imageManager.LoadFromFile(ParsePastImageProgram(lexer), TextureFilter.Default, TextureRepeat.Clamp, TextureUsage.Default);
